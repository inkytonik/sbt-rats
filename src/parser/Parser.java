...
// on Tuesday, 10 July 2012 at 3:00:46 PM.
...
public final class Parser extends ParserBase {
  ...
  private Result pASTPrimary(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fASTPrimary) 
      yyColumn.chunk1.fASTPrimary = pASTPrimary$1(yyStart);
    return yyColumn.chunk1.fASTPrimary;
  }

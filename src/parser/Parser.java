...
// on Sunday, 8 July 2012 at 2:12:20 PM.
...
public final class Parser extends ParserBase {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("=")) {
          ...
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            List<Element> as = yyResult.semanticValue();

            yyValue = new StringRule (i, as);
      ...
      { // Start scope for t.
        ...
        if (yyResult.hasValue("=")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = new ASTRule (i, t, as, false);
  ...
  static {
    add (KEYWORDS, new String[] {
      "comment", "end", "header", "left", "rats", "right", "String"
    });
  }

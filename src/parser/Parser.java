...
// on Thursday, 15 November 2012 at 8:41:31 AM.
...
public final class Parser extends ParserBase {
  ...
  private Result pASTPrimary$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("(")) {
      ...
      yyResult = pASTSingleNonterm(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal parser.Parser.ASTSingleNonterm.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pASTSingleNonterm(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fASTSingleNonterm) 
      yyColumn.chunk2.fASTSingleNonterm = pASTSingleNonterm$1(yyStart);
    return yyColumn.chunk2.fASTSingleNonterm;
  }

  /** Actually parse parser.Parser.ASTSingleNonterm. */
  private Result pASTSingleNonterm$1(final int yyStart) throws IOException {
    Result     yyResult;
    Element    yyValue;
    ParseError yyError = ParseError.DUMMY;

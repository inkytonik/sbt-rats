...
// on Tuesday, 30 October 2012 at 2:10:14 PM.
...
public final class Parser extends ParserBase {
      ...
      { // Start scope for h.
        ...
        { // Start scope for b.
          ...
          while (true) {
            ...
            if (yyResult.hasValue()) {
              Rule v$el$3 = yyResult.semanticValue();

              yyRepetition1 = yyResult.index;
              yyRepValue1   = new $colon$colon<Rule>(v$el$3, yyRepValue1);
              continue;
            }
            break;
          }
  ...
  static {
    add (KEYWORDS, new String[] {
      ...
      "none", "paren", "rats", "right", "sp", "String"
    });
  }

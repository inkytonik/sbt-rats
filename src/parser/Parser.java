...
// on Wednesday, 11 July 2012 at 9:28:14 PM.
...
public final class Parser extends ParserBase {
  ...
  /**
   * Parse nonterminal parser.Parser.Parenthesized.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pParenthesized(final int yyStart) throws IOException {
    ...
    // Done.
    yyError = yyError.select("parenthesized expected", yyStart);
    return yyError;
  }
  ...
  static {
    add (KEYWORDS, new String[] {
      "comment", "end", "header", "left", "nest", "none", "paren",
      "rats", "right", "sp", "String"
    });
  }

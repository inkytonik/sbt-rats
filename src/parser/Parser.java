...
// on Tuesday, 10 July 2012 at 12:01:42 PM.
...
public final class Parser extends ParserBase {
  ...
  private Result pASTAlternative$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ASTElement e = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError, yyOption1);
      if (yyResult.hasValue()) {
        List<Annotation> v$el$1 = yyResult.semanticValue();
  ...
  private Result pElement$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ASTElement seed = yyResult.semanticValue();
  ...
  private Result pElement1$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Action<ASTElement>> actions = yyResult.semanticValue();
  ...
  private Result pElement1$$Plus1$1(final int yyStart) throws IOException {
    Result                   yyResult;
    Pair<Action<ASTElement>> yyValue;
    ParseError               yyError = ParseError.DUMMY;
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Action<ASTElement> v$el$2 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Action<ASTElement>> v$3 = yyResult.semanticValue();

        yyValue = new Pair<Action<ASTElement>>(v$el$2, v$3);
      ...
      yyValue = new Pair<Action<ASTElement>>(v$el$2);
  ...
  private Result pSeqnTail(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final ASTElement right = yyResult.semanticValue();

      yyValue = new Action<ASTElement> () {
        public ASTElement run (ASTElement left) {
  ...
  private Result pPrimary$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("!")) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        ASTElement p = yyResult.semanticValue();
  ...
  private Result pAnnotations(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fAnnotations) 
      yyColumn.chunk1.fAnnotations = pAnnotations$1(yyStart);
    return yyColumn.chunk1.fAnnotations;
  }

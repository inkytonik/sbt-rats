...
// on Saturday, 4 October 2014 at 7:59:32 PM.
...
public final class Parser extends ParserBase {
  ...
  void setLocation(final Object object, final int index) {
    if (null != object) {
      Column c = column(index);
      Positions.setStart(object, new LineColPosition(c.line, c.column, index));
    }
  }

...
// on Thursday, 5 July 2012 at 11:25:25 AM.
...
public final class Parser extends ParserBase {
  ...
  /**
   * Parse nonterminal parser.Parser.CommentDef.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pCommentDef(final int yyStart) throws IOException {
    Result     yyResult;
    CommentDef yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    // Done.
    yyError = yyError.select("comment def expected", yyStart);
    return yyError;
  }

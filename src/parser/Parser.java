...
// on Tuesday, 30 October 2012 at 4:12:09 PM.
...
public final class Parser extends ParserBase {
  ...
  static final class Chunk1 {
    ...
    Result fOption;
    Result fType;
    Result fStringAlternatives;
    Result fStringAlternatives$$Star1;
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for h.
        ...
        { // Start scope for b.
          ...
          yyError  = yyResult.select(yyError, yyOption1);
          if (yyResult.hasValue()) {
            List<RatsOption> v$el$3 = yyResult.semanticValue();

            yyOption1  = yyResult.index;
            yyOpValue1 = v$el$3;
          }
          { // Start scope for o.
            List<RatsOption> o = cast(yyOpValue1);
            ...
            { // Start scope for rs.
              ...
              if (yyResult.hasValue()) {
                ...
                yyValue = new Grammar (p, h, b, o, rs);
  ...
  private Result pOptions(final int yyStart) throws IOException {
    ...
    int              yyBase;
    int              yyRepetition1;
    List<RatsOption> yyRepValue1;
    List<RatsOption> yyValue;
    ParseError       yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("option")) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        RatsOption h = yyResult.semanticValue();
        ...
        while (true) {
          ...
          if (yyResult.hasValue(",")) {
            ...
            yyError  = yyResult.select(yyError, yyRepetition1);
            if (yyResult.hasValue()) {
              RatsOption v$el$1 = yyResult.semanticValue();

              yyRepetition1 = yyResult.index;
              yyRepValue1   = new $colon$colon<RatsOption>(v$el$1, yyRepValue1);
              continue;
            }
          } else {
            yyError = yyError.select("',' expected", yyBase);
        ...
        { // Start scope for tl.
          List<RatsOption> tl = yyRepValue1.reverse();
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("=")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = new StringRule (i, alts, false);
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("=")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = new StringRule (i, alts, true);
  ...
  /** Actually parse parser.Parser.StringAlternatives. */
  private Result pStringAlternatives$1(final int yyStart) throws IOException {
    Result        yyResult;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pStringAlternatives$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        List<Element> tl = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal parser.Parser.StringAlternatives$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pIdnDef(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fIdnDef) 
      yyColumn.chunk2.fIdnDef = pIdnDef$1(yyStart);
    return yyColumn.chunk2.fIdnDef;
  }
  ...
  static {
    add (KEYWORDS, new String[] {
      "body", "header", "left", "line", "module", "nest",
      "none", "option", "paren", "rats", "right", "setOfString",
      "sp", "String", "verbose"
    });
  }

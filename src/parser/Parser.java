...
// on Thursday, 12 July 2012 at 12:47:17 PM.
...
public final class Parser extends ParserBase {
  ...
  private Result pGrammarRule(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for t.
        ...
        yyError  = yyResult.select(yyError, yyOption1);
        if (yyResult.hasValue()) {
          List<Annotation> v$el$2 = yyResult.semanticValue();

          yyOption1  = yyResult.index;
          yyOpValue1 = v$el$2;
        }
        { // Start scope for anns.
          List<Annotation> anns = cast(yyOpValue1);
  ...
  private Result pASTAlternative$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError, yyOption1);
      if (yyResult.hasValue()) {
        List<Annotation> v$el$3 = yyResult.semanticValue();

        yyOption1  = yyResult.index;
        yyOpValue1 = v$el$3;
      }
      { // Start scope for as.
        List<Annotation> as = yyOpValue1;
  ...
  private Result pAnnotationList(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Annotation h = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue(",")) {
          ...
          yyError  = yyResult.select(yyError, yyRepetition1);
          if (yyResult.hasValue()) {
            Annotation v$el$1 = yyResult.semanticValue();

            yyRepetition1 = yyResult.index;
            yyRepValue1   = new $colon$colon<Annotation>(v$el$1, yyRepValue1);
            continue;
          }
        } else {
          yyError = yyError.select("',' expected", yyBase);
      ...
      { // Start scope for tl.
        List<Annotation> tl = yyRepValue1.reverse();
  ...
  private Result pAnnotation(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fAnnotation) 
      yyColumn.chunk2.fAnnotation = pAnnotation$1(yyStart);
    return yyColumn.chunk2.fAnnotation;
  }
  ...
  static {
    add (KEYWORDS, new String[] {
      "comment", "end", "header", "left", "line", "nest", "none",

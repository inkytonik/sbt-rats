...
// on Thursday, 21 July 2016 at 5:24:19 PM.
...
public final class Parser extends ParserBase {
  ...
  private Result pTreeAtMostOneNonterm$1(final int yyStart) 
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pTreeLiterals(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal parser.Parser.TreeLiterals.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTreeLiterals(final int yyStart) throws IOException {
    Result                yyResult;
    int                   yyRepetition1;
    boolean               yyRepeated1;
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pTreeLiteralsTail(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Action<Element> v$el$2 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal parser.Parser.TreeLiteralsTail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTreeLiteralsTail(final int yyStart) throws IOException {
    Result          yyResult;
    Action<Element> yyValue;
    ParseError      yyError = ParseError.DUMMY;

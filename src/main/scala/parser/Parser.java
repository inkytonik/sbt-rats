...
// on Wednesday, 8 April 2020 at 4:23:48 PM.
...
public final class Parser extends ParserBase {
  ...
  private Result pTokenType(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fTokenType) 
      yyColumn.chunk1.fTokenType = pTokenType$1(yyStart);
    return yyColumn.chunk1.fTokenType;
  }

  /** Actually parse parser.Parser.TokenType. */
  private Result pTokenType$1(final int yyStart) throws IOException {
    Result     yyResult;
    IdnUse     yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pStringElement1(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk2.fStringElement1) 
      yyColumn.chunk2.fStringElement1 = pStringElement1$1(yyStart);
    return yyColumn.chunk2.fStringElement1;
  }
  ...
  private Result pFormatting(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fFormatting) 
      yyColumn.chunk3.fFormatting = pFormatting$1(yyStart);
    return yyColumn.chunk3.fFormatting;
  }
  ...
  private Result pRatsRule(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(":")) {
        ...
        yyResult = pStringType(yyChoice2);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue("=")) {
            ...
            if (yyResult.hasValue("rats")) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyValue = new RatsRule (i, new IdnUse ("Token"), s);

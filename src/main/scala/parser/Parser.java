...
// on mardo, 13-a de julio 2021 at 16:21:40.
...
public final class Parser extends ParserBase {
  ...
  static final class Chunk2 {
    ...
    Result fTreeFactor;
    Result fTreePrimary;
    Result fTreeSingleFactor;
    Result fTreeNoFactor;
    Result fTreeLiteral;
    Result fFormatting;
    Result fRuleAnnotations;
  }

  /** Chunk 3 of memoized results. */
  static final class Chunk3 {
    Result fRuleAnnotation;
    Result fAstRuleAnnotation;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        { // Start scope for h.
          ...
          yyResult = pASTHeaderSection(yyOption1);
          yyError  = yyResult.select(yyError, yyOption1);
          if (yyResult.hasValue()) {
          ...
          { // Start scope for a.
            ...
            { // Start scope for b.
              ...
              yyError  = yyResult.select(yyError, yyOption1);
              if (yyResult.hasValue()) {
                List<SyntaxOption> v$el$4 = yyResult.semanticValue();
              ...
              { // Start scope for o.
                ...
                while (true) {
                  ...
                  if (yyResult.hasValue()) {
                    Rule v$el$5 = yyResult.semanticValue();

                    yyRepetition1 = yyResult.index;
                    yyRepValue1   = new $colon$colon<Rule>(v$el$5, yyRepValue1);
                    continue;
                  }
                  break;
                }
  ...
  /**
   * Parse nonterminal parser.Parser.ASTHeaderSection.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pASTHeaderSection(final int yyStart) throws IOException {
    Result     yyResult;
    String     yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pWord(yyStart);
    if (yyResult.hasValue("astHeader")) {
    ...
    // Done.
    yyError = yyError.select("a s t header section expected", yyStart);
    return yyError;
  }
              ...
              case '*':
                {
                  ...
                  while (true) {
                    ...
                    if (! yyPredMatched) {
                      ...
                      yyError = yyError.select("code block text expected", yyStart);
                    }
                    break;
                  }
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(":")) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyError  = yyResult.select(yyError, yyOption1);
          if (yyResult.hasValue()) {
            List<RuleAnnotation> v$el$1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError, yyOption1);
      if (yyResult.hasValue()) {
        IdnUse v$el$2 = yyResult.semanticValue();
      ...
      { // Start scope for t.
        ...
        yyResult = pAstRuleAnnotations(yyOption1);
        yyError  = yyResult.select(yyError, yyOption1);
        if (yyResult.hasValue()) {
          List<RuleAnnotation> v$el$3 = yyResult.semanticValue();
  ...
  private Result pStringRuleType(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fStringRuleType) 
      yyColumn.chunk1.fStringRuleType = pStringRuleType$1(yyStart);
    return yyColumn.chunk1.fStringRuleType;
  }

  /** Actually parse parser.Parser.StringRuleType. */
  private Result pStringRuleType$1(final int yyStart) throws IOException {
    Result     yyResult;
    IdnUse     yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pStringElement1$$Plus1(final int yyStart) 
    ...
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fStringElement1$$Plus1) 
      yyColumn.chunk1.fStringElement1$$Plus1 = pStringElement1$$Plus1$1(yyStart);
    return yyColumn.chunk1.fStringElement1$$Plus1;
  }
  ...
  private Result pTreeElement(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fTreeElement) 
      yyColumn.chunk2.fTreeElement = pTreeElement$1(yyStart);
    return yyColumn.chunk2.fTreeElement;
  }

  /** Actually parse parser.Parser.TreeElement. */
  private Result pTreeElement$1(final int yyStart) throws IOException {
    Result     yyResult;
    Element    yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pTreePrimary$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("(")) {
      ...
      yyResult = pTreeSingleFactor(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal parser.Parser.TreeSingleFactor.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTreeSingleFactor(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fTreeSingleFactor) 
      yyColumn.chunk2.fTreeSingleFactor = pTreeSingleFactor$1(yyStart);
    return yyColumn.chunk2.fTreeSingleFactor;
  }

  /** Actually parse parser.Parser.TreeSingleFactor. */
  private Result pTreeSingleFactor$1(final int yyStart) throws IOException {
    Result     yyResult;
    Element    yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pTreeNoFactors(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal parser.Parser.TreeNoFactors.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTreeNoFactors(final int yyStart) throws IOException {
    Result                yyResult;
    int                   yyRepetition1;
    boolean               yyRepeated1;
    ...
    yyResult = pTreeNoFactor(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Element seed = yyResult.semanticValue();
      ...
      while (true) {
        ...
        yyResult = pTreeNoFactorsTail(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Action<Element> v$el$2 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal parser.Parser.TreeNoFactorsTail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTreeNoFactorsTail(final int yyStart) throws IOException {
    Result          yyResult;
    Action<Element> yyValue;
    ParseError      yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal parser.Parser.TreeNoFactor.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTreeNoFactor(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fTreeNoFactor) 
      yyColumn.chunk2.fTreeNoFactor = pTreeNoFactor$1(yyStart);
    return yyColumn.chunk2.fTreeNoFactor;
  }

  /** Actually parse parser.Parser.TreeNoFactor. */
  private Result pTreeNoFactor$1(final int yyStart) throws IOException {
    Result     yyResult;
    Element    yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pRuleAnnotations(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fRuleAnnotations) 
      yyColumn.chunk2.fRuleAnnotations = pRuleAnnotations$1(yyStart);
    return yyColumn.chunk2.fRuleAnnotations;
  }

  /** Actually parse parser.Parser.RuleAnnotations. */
  private Result pRuleAnnotations$1(final int yyStart) throws IOException {
    Result               yyResult;
    int                  yyBase;
    ...
    if (yyResult.hasValue("{")) {
      ...
      yyResult = pRuleAnnotationsList(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal parser.Parser.RuleAnnotationsList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pRuleAnnotationsList(final int yyStart) throws IOException {
    Result               yyResult;
    int                  yyBase;
    int                  yyRepetition1;
  ...
  /**
   * Parse nonterminal parser.Parser.AstRuleAnnotations.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAstRuleAnnotations(final int yyStart) throws IOException {
    Result               yyResult;
    int                  yyBase;
    List<RuleAnnotation> yyValue;
    ParseError           yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("{")) {
      ...
      yyResult = pAstRuleAnnotationsList(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
    ...
    // Done.
    yyError = yyError.select("ast rule annotations expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal parser.Parser.AstRuleAnnotationsList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAstRuleAnnotationsList(final int yyStart) 
    throws IOException {
    ...
    yyResult = pAstRuleAnnotation(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      RuleAnnotation h = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue(",")) {
          ...
          yyResult = pAstRuleAnnotation(yyResult.index);
          yyError  = yyResult.select(yyError, yyRepetition1);
          if (yyResult.hasValue()) {
            RuleAnnotation v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal parser.Parser.AstRuleAnnotation.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAstRuleAnnotation(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fAstRuleAnnotation) 
      yyColumn.chunk3.fAstRuleAnnotation = pAstRuleAnnotation$1(yyStart);
    return yyColumn.chunk3.fAstRuleAnnotation;
  }

  /** Actually parse parser.Parser.AstRuleAnnotation. */
  private Result pAstRuleAnnotation$1(final int yyStart) throws IOException {
    Result         yyResult;
    RuleAnnotation yyValue;
    ParseError     yyError = ParseError.DUMMY;
    ...
    // Done.
    yyError = yyError.select("ast rule annotation expected", yyStart);
    return yyError;
  }
  ...
  private Result pRatsRule(final int yyStart) throws IOException {
    ...
    int                  yyBase;
    int                  yyOption1;
    List<RuleAnnotation> yyOpValue1;
    RatsRule             yyValue;
    ParseError           yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(":")) {
        ...
        if (yyResult.hasValue()) {
          ...
          { // Start scope for anns.
            List<RuleAnnotation> anns = yyOpValue1;

...
// on vendredo, 9-a de julio 2021 at 16:07:30.
...
public final class Parser extends ParserBase {
  ...
  private Result pRuleAnnotations(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fRuleAnnotations) 
      yyColumn.chunk3.fRuleAnnotations = pRuleAnnotations$1(yyStart);
    return yyColumn.chunk3.fRuleAnnotations;
  }
  ...
  private Result pCharClassCharacter(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk4.fCharClassCharacter) 
      yyColumn.chunk4.fCharClassCharacter = pCharClassCharacter$1(yyStart);
    return yyColumn.chunk4.fCharClassCharacter;
  }

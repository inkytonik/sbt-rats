...
The pretty-printers produced by the plugin and a few other convenience features are designed to work with the [Kiama language processing library](https://github.com/inkytonik/kiama).
